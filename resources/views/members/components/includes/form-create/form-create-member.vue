<template>
    ...
    <ssf-container class="mx-auto" name="form-create-member" not-full>
        ...
        <ssf-container class="mt-5" name="step-content">
            ...
            <form id="formCreateMember" novalidate>
        ...
        <modal-recap v-if="modals.recapBeforeSave.open"
                     ...
                     :member="modals.recapBeforeSave.props.member"
...
<script lang="ts">
    ...
    import PersonalInformations
                                       from "@/views/members/components/includes/form-create/steps/personal-informations.vue";
    import CompanyInformations
                                       from "@/views/members/components/includes/form-create/steps/company-informations.vue";
    import Documents
                                       from "@/views/members/components/includes/form-create/steps/documents.vue";
    import { Nullable }                from "../../../../../../types/nullable";
    import { validator as xValidator } from "@app/commons/validation";
    import ModalRecap
                                       from "@/views/members/components/includes/form-create/steps/modal-recap.vue";
    import { AxiosApiError }           from "@sofiakb/axios-api/lib/tools/api";
    import { MainSuccess }             from "@app/vue/utils/swal";
    import { useStore }                from "vuex";

    export default defineComponent({
        name      : "form-create-member",
        ...
        setup() {
            ...
            const member = ref<Member>((new Member()).__setItemAttributes({}))
        ...
        methods: {
            ...
            save() {
                ...
                if (!this.member.activityId || this.member.activityId === '') {
                ...
                Member.send(this.member)
                    .then(() => {
                        MainSuccess.fire()
                        this.currentStep = 1
                        return this.member = new Member();
                    })
